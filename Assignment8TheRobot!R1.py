...
def mouseClicked():
    ...
    fill((mouse_y/255)*500,(mouse_x/255)*500,0)
    #turns the mouse x and y coordinates into usable values up to 255 and uses it as the background of the hands and feet
    ellipse(234,255,20,20)
